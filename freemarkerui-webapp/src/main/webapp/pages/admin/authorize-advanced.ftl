...
<div>
    <@dspace.message "ui.dspace-admin.authorize-advanced.text" />
    <a href="<@dspace.url "/help/site-admin.html#advancedpolicies" />" onClick="javascript: popup_window(this, 'group_popup'); return false;"><@dspace.message "ui.morehelp" /></a>
</div>
    ...
    <div align="center">
        <table width="70%">
            <tr>
                ...
                <td align="right">
                    <input type="submit" name="submit_advanced_clear" value="<@dspace.message "ui.dspace-admin.authorize-advanced.clear" />"/>
                </td>
                <td>
