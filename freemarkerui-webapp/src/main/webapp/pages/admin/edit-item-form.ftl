...
<div>
    <a href="<@dspace.url "/help/collection-admin.html#editmetadata" />"
    ...
    <table id="aspect_administrative_item_EditItemStatusForm_list_item-info" class="ds-gloss-list">
        ...
        <tr class="ds-table-row even ">
            ...
            <#if item.isWithdrawn() >
                ...
                <input id="reinstate" class="ds-button-field" name="reinstate" type="submit" value="Reinstate..."
                       onclick="return confirm('Are you sure?')">
                <#else >
                    <input id="withdraw" class="ds-button-field" name="withdraw" type="submit" value="Withdraw..."
                           onclick="return confirm('Are you sure?')">
            </#if>
            </td>
        </tr>
        ...
        <tr class="ds-table-row even ">
            ...
            <td>
                <input id="delete" class="ds-button-field" name="delete" type="submit" value="Permanently Delete"
                       onclick="return confirm('Are you sure?')">
            </td>
        </tr>
    </table></form>
        ...
        <tr>
            <td>
                ...
                <#-- TODO Fetch fields from database instead of hard coded. -->
                    ...
                    <option value="dc_description_statementofresponsibility">dc.description.statementofresponsibility
                    </option>
            ...
            <td><input id="field_language" class="ds-text-field" name="language_${row}" type="text" value="" size="6">
            </td>
            <td></td>
        </tr>
        </tfoot>
...
<#list item.getBundles() as bundle>
    ...
    <#list bundle.getBitstreams() as bitstream>
        <tr>
            <form method="post" action="<@dspace.url "/admin/bitstream/${bitstream.getID()}"/>">
                ...
                <td><input class="ds-button-field" name="delete" type="submit" value="Delete"
    ...
    <tr>
        <td colspan="4"><a href="<@dspace.url "/admin/item/${item.getID()}/bitstream/new"/>">Upload a new bitstream</a>
        </td>
    </tr>
</table>
